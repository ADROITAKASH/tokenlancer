          ...
          <Col sm={3}>
            <Nav variant="pills" className="flex-Row">
              <Nav.Item onClick={() => { history.push('/browse-job') }}>
                <Nav.Link eventKey="second">Freelancer</Nav.Link>
              </Nav.Item>
              <Nav.Item onClick={() => history.push('/post-Job')}>
                <Nav.Link eventKey="first">Hirer</Nav.Link>
              </Nav.Item>
            </Nav>
          </Col>
          <Col sm={9}>
            <Tab.Content>
              <Tab.Pane eventKey="first">
                <span className='tab'>
                  ...
                  <h4><Link to="/Hicontract">Contract</Link> </h4>
                </span>
              </Tab.Pane>
              <Tab.Pane eventKey="second">
                <span className='tab'>
                  ...
                  <h4><Link to="/contract">Contract</Link> </h4>
                </span>
              </Tab.Pane>
